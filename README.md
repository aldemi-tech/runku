...
| Logical Object Storage authority | Revisioned bucket/object/access-key domain, SQLite/PostgreSQL metadata authority, content-addressed filesystem/S3 bytes, authenticated console object transfer/browser API, one-time secrets, and server composition implemented and test-covered; S3-facing protocol, multipart, signed/public URLs, lifecycle execution, coordinated backup, native SDK, and CLI surfaces are not yet implemented |
