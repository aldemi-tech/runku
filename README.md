...
| Compact/cell `runku-server` binary/image for Linux ARM64/x86_64 | Same binary composes one compact Environment or a strict shared/dedicated cell member with Safe V8; an explicit dedicated one-trust-domain profile adds bounded in-container Node workers |
