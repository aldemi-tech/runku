...
| Compact/cell `runku-server` binary/image for Linux ARM64/x86_64 | Same binary composes one compact Environment or a strict shared/dedicated cell member with Safe V8; explicit dedicated one-trust-domain profiles add bounded in-container or separate-container Node workers |
