...
public HTTP envelopes, realtime messages, Release manifests (including the additive storage
capability/runtime contract) and routing, Safe ESM bundles, source builds, and stored values.
