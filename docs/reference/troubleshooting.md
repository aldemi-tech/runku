...
| Management readiness fails | Identity or configured Function platform PostgreSQL/schema unavailable | Preserve server error code; verify both dependencies and migration checksums |
...
configured, the Environment-scoped Function platform PostgreSQL check. Product
...
restore. See [Environment-scoped Function platform PostgreSQL](../self-hosting/product-postgresql.md).
