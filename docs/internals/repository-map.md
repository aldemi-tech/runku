...
| `runku-object-storage` | Provider-independent logical buckets, current/version object metadata, Product access keys, idempotency, CAS, and audit contracts |
| `runku-object-storage-repository` | Checksum-migrated SQLite/PostgreSQL bucket/object/key authority, quota enforcement, journals, and conformance |
